...
test('★ ACQUIS — la couche du marché vient après les autres, en dernier paramètre', () => {
  ...
  assert.deepEqual(params.slice(12), ['matchRetour', 'secondAvis', 'grilleSeconde', 'plusDeDeuxCinqDuMarche'], 'Un paramètre a été inséré ou ajouté sans que ce garde-fou le sache.');
  assert.match(
    s,
