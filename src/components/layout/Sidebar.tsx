...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Top Header Mobile */}
      <div className="lg:hidden fixed top-0 left-0 w-full h-20 bg-[#16242e]/95 backdrop-blur-md border-b border-white/5 z-40 flex items-start justify-between pt-6 px-6 pointer-events-none">
