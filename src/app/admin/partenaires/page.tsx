...
import {
  ArrowRight, Coins, Handshake, Percent, Users, Wallet,
} from "lucide-react";
          ...
          <div className="relative overflow-hidden rounded-[26px] border border-[#8b5cf6]/30 bg-gradient-to-br from-[#8b5cf6]/12 via-[#16242e] to-[#111d25] p-6 sm:p-7">
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-5">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-black text-white tabular-nums mt-1">
              ...
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-black text-[#a78bfa] tabular-nums mt-1">
              ...
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-black text-[#10b981] tabular-nums mt-1">
            ...
            <div className="space-y-3">
              {partenaires.map((p) => (
                <Link
                  ...
                  className="block rounded-[18px] border border-[#2e4757] bg-[#1a2b36] p-4 hover:border-[#8b5cf6]/40 transition-colors"
                >
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="text-[11px] text-white/35 mt-1 truncate">{p.email}</p>
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <p className="text-xl font-black text-[#a78bfa] tabular-nums">
                        {fcfa(p.duMoisEnCoursXof)}
                      </p>
                      <p className="text-[10px] text-white/30">
                        {p.part_ca_pct} % de {fcfa(p.recettesMoisEnCoursXof)}
                      </p>
                      <span className="inline-flex items-center gap-1 text-[11px] font-bold text-[#8b5cf6] mt-1.5">
