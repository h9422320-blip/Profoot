  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      role: "assistant",
      content: "Bienvenue dans votre espace VIP 👋\n\nJe suis **ProFoot Expert**, votre analyste football IA personnel. Je suis connecté en temps réel à l'actualité du football.\n\nPosez-moi n'importe quelle question : statistiques d'un joueur, analyse tactique, pronostic de match, transferts, résultats en direct... Je suis là pour vous donner les meilleures réponses.\n\n⚽ Par quoi voulez-vous commencer ?"
    }
  ]);
