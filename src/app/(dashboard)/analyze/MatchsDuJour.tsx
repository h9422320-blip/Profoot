      ...
      >
        {matchs.map((m) => {
          ...
          return (
            ...
            >
              {/* ── AUCUN TAUX AVANT QUE L'UTILISATEUR AIT DEMANDÉ ────────
                  Décision du propriétaire, 6 septembre 2026 : « je ne veux pas
                  que tu mettes cinquante-quatre pour cent ici. Tant que
                  l'utilisateur n'a pas cliqué pour analyser, il ne faut pas le
                  mettre là-bas. »

                  Le taux reste calculé et sert TOUJOURS à ordonner le
                  carrousel — les rencontres les mieux cernées passent devant —
                  mais il ne s'affiche plus qu'à l'intérieur de l'analyse, une
                  fois qu'elle a été demandée. */}
