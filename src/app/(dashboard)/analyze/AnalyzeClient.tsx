                ...
                <div className={`space-y-8 ${result.locked ? 'pointer-events-none select-none blur-[16px] opacity-[0.8] saturate-125' : ''}`}>
                  ...
                  {result.predictedScore && (
                    <div className="bg-[#1d2f3a]/60 backdrop-blur-md border border-white/5 rounded-[32px] p-6 md:p-8 shadow-lg">
                      ...
                      {/* ── LES DEUX SIGLES SE CALCULENT ENSEMBLE ──────────────
                          Séparément, Real Betis et Real Madrid donnaient tous
                          deux « REA » : le lecteur ne pouvait plus dire à qui
                          appartenait le 2 et à qui appartenait le 1, sur la
                          seule carte de l'écran qui doit se lire d'un coup
                          d'œil. Le cas est fréquent — Manchester United et
                          Manchester City, Real et Atlético Madrid. */}
                      <div className="flex items-center justify-center gap-4 md:gap-12 my-6 w-full">
                        <div className="flex flex-col items-center gap-2 w-[30%]">
                          ...
                          <span className="text-xs font-black text-white/75 text-center truncate">
                            {siglesDuMatch(getClub(team1!).name, getClub(team2!).name)[0]}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-2 w-[30%]">
                          ...
                          <span className="text-xs font-black text-white/75 text-center truncate">
                            {siglesDuMatch(getClub(team1!).name, getClub(team2!).name)[1]}
                          </span>
                        </div>
                      </div>
