...
const OFFRES = [
  {
    ...
    exclus: ['Agent IA VIP non inclus'],
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-4xl font-black tracking-tight">{offre.prix}</span>
                  ...
                  {offre.economie && (
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-success/10 border border-success/25">
                      ...
                      <span className="text-[11px] font-black text-success">{offre.economie}</span>
                    </div>
                  )}
                </div>
